...
public class Motocicleta implements Vehiculo{
    ...
    @Override
    public void avanzar() {
        System.out.println("Avanzando con la moticicleta de " + this.centimetrosCubicos + "C.C.");
    }

    @Override
    public void frenar() {
        System.out.println("Frenando con la moticicleta de " + this.centimetrosCubicos + "C.C.");
